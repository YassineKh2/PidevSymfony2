 ...
 */
final class Version20230310081255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ADD latitude DOUBLE PRECISION NOT NULL, ADD longitude DOUBLE PRECISION NOT NULL');
        $this->addSql('ALTER TABLE evenement ADD numberoflikes INT DEFAULT NULL, ADD description LONGTEXT NOT NULL, ADD places_restantes INT NOT NULL');
        $this->addSql('ALTER TABLE publication CHANGE image_forum image_forum VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP numberoflikes, DROP description, DROP places_restantes');
        $this->addSql('ALTER TABLE publication CHANGE image_forum image_forum VARCHAR(255) DEFAULT NULL');
    }
}
